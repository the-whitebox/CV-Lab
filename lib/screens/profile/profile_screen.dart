...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> changePasswordAPI({
    ...
    if (await isInternetConnected()) {
      ...
      customLog('old $oldPassword and new $newPassword');
            ...
            body: FutureBuilder(
                ...
                builder: (context, AsyncSnapshot<Map<String, dynamic>> snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    return Center(
                        child: RotatingImage(
                            height: isLargerScreen ? screenHeight * 0.25 : screenHeight * 0.20, width: isLargerScreen ? screenWidth * 0.25 : screenWidth * 0.2));
                  } else if (snapshot.hasError) {
                    return Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                      const Expanded(flex: 1, child: SizedBox()),
                      Text('Something went wrong', style: isLargerScreen ? kFont24 : kFont24SmallScreen),
                      const SizedBox(height: 10),
                      snapshot.error.toString().contains("SocketException")
                          ? const Padding(padding: EdgeInsets.all(8), child: Text("Please Check your internet connection and try again."))
                          : Text("Error : ${snapshot.error}"),
                      const Expanded(flex: 2, child: SizedBox()),
                      SizedBox(height: screenHeight * 0.2, child: Image.asset(AppImages.sleepyDog)),
                      const Expanded(flex: 2, child: SizedBox()),
                      Padding(
                          ...
                          child: ElevatedButton(
                              onPressed: () async {
                                ...
                                homeController.refreshResponse();
                              },
                              ...
                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                Icon(Icons.logout_outlined, color: kHighlightedColor, size: isLargerScreen ? 24 : 18),
                                const SizedBox(width: 5),
                                Text('Log out', style: kButtonTextStyle.copyWith(color: kHighlightedColor, fontSize: isLargerScreen ? 20 : 18))
                              ])))
                    ]);
                  } else {
                    return SafeArea(
                        child: SingleChildScrollView(
                            ...
                            child: Stack(children: [
                              Image.asset(AppImages.bgPawsWithOrange),
                              Padding(
                                  padding: const EdgeInsets.all(1),
                                  child: Column(children: [
                                    SizedBox(height: isLargerScreen ? screenHeight * 0.02 : screenHeight * 0.06),
                                    Visibility(visible: _isMyProfile, child: Text('My profile', style: isLargerScreen ? kFont24 : kFont24SmallScreen)),
                                    Visibility(visible: _isEditProfile, child: Text('Edit profile', style: isLargerScreen ? kFont24 : kFont24SmallScreen)),
                                    Visibility(visible: _isChangePassword, child: Text('Change password', style: isLargerScreen ? kFont24 : kFont24SmallScreen)),
                                    Visibility(
                                        visible: _isMyProfile,
                                        child: Padding(
                                            padding: EdgeInsets.symmetric(vertical: screenHeight * 0.025, horizontal: screenWidth * 0.03),
                                            child: buildProfileContainer(screenHeight, screenWidth, isLargerScreen, context, snapshot.data!))),
                                    Visibility(
                                        visible: _isEditProfile,
                                        child: Padding(
                                            padding: EdgeInsets.symmetric(vertical: screenHeight * 0.025, horizontal: screenWidth * 0.03),
                                            child: buildEditProfileContainer(context, snapshot.data!, screenHeight, screenWidth, isLargerScreen))),
                                    Visibility(
                                        visible: _isChangePassword,
                                        child: Padding(
                                            padding: EdgeInsets.symmetric(vertical: screenHeight * 0.025, horizontal: screenWidth * 0.03),
                                            child: buildChangePasswordContainer(context, screenHeight, screenWidth, isLargerScreen)))
                                  ]))
                            ])));
                  }
                })));
  ...
  Container buildProfileContainer(double screenHeight, double screenWidth, bool isLargerScreen, BuildContext context, Map<String, dynamic> userData) {
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            color: Colors.transparent, borderRadius: BorderRadius.circular(25.0), border: Border.all(color: const Color(0x4D000000).withOpacity(0.08), width: 3)),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              child: GestureDetector(
                  child: Padding(
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.white, border: Border.all(color: kPurple, width: 2)),
                          child: Image.asset(AppImages.edit, width: 20, height: 20))),
                  onTap: () {
                    setState(() {
                      _isMyProfile = false;
                      _isEditProfile = true;
                    ...
                    : (selectedAvatarIndex != 0)
                        ...
                        : (imageNetwork != null)
                            ...
                            : (avatarIndexNetwork != null)
                                ? AssetImage(avatarList[avatarIndexNetwork!]) as ImageProvider<Object>
                                : const AssetImage('fallback_image_path') as ImageProvider<Object>),
            Positioned.fill(
                child: Transform.rotate(
                    angle: 3.14 / 2, child: CircularProgressIndicator(backgroundColor: Colors.white, value: 0.5, color: kPurple, strokeWidth: isLargerScreen ? 14 : 10)))
          ])),
          ...
          Padding(
              ...
              child: Center(
                  child: Column(children: [
                Text('${userData['first_name']} ${userData['last_name']}', style: isLargerScreen ? kFont24Username : kFont24Username.copyWith(fontSize: 20)),
          ...
          GestureDetector(
              ...
              child: Padding(
                  ...
                  child:
                      Row(children: [Image.asset(AppImages.lock, height: 20, width: 20), const SizedBox(width: 5), const Text('Change password', style: kFont14Black)]))),
          const Divider(color: kLightGrey),
          // GestureDetector(
          //   onTap: () {
          ...
          Padding(
              padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.05, vertical: screenHeight * 0.005),
              child: Row(children: [
                Image.asset(AppImages.notification, height: 20, width: 20),
                const SizedBox(width: 5),
                const Text('Notification', style: kFont14Black),
                const Spacer(),
                Transform.scale(
                    scale: 0.4,
                    child: SizedBox(
  ...
  Container buildEditProfileContainer(BuildContext context, Map<String, dynamic> userData, double screenHeight, double screenWidth, bool isLargerScreen) {
    return Container(
          ...
          Stack(children: [
            Center(
              ...
              Positioned.fill(
                  child: Transform.rotate(
                      angle: 3.14 / 2,
                      child: CircularProgressIndicator(backgroundColor: Colors.white, value: 0.5, color: kPurple, strokeWidth: isLargerScreen ? 14 : 10)))
            ])),
            Positioned(
                ...
                child: GestureDetector(
                    child: Container(
                        ...
                        child: Image.asset(AppImages.edit, width: 20, height: 20)),
                    onTap: () {
                      _showChangeProfilePictureDialog(context, screenHeight, screenWidth, isLargerScreen);
                    }))
          ]),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ElevatedButton(
                ...
                style: kElevatedButtonWhiteOpacityBG.copyWith(
                    elevation: WidgetStateProperty.all(0.001), padding: WidgetStateProperty.all(EdgeInsets.symmetric(vertical: 0, horizontal: screenWidth * 0.08))),
                child: Text('Cancel', style: kFont14Black.copyWith(fontSize: 16))),
            ...
            ElevatedButton(
                ...
                style: kElevatedButtonWhiteOpacityBG.copyWith(
                    elevation: WidgetStateProperty.all(0.001),
                    padding: WidgetStateProperty.all(EdgeInsets.symmetric(vertical: 0, horizontal: screenWidth * 0.08)),
                    backgroundColor: const WidgetStatePropertyAll(kHighlightedColor)),
                child: Text('Save', style: kFont14.copyWith(fontSize: 16)))
          ])
        ]));
  }

  Container buildChangePasswordContainer(BuildContext context, double screenHeight, double screenWidth, bool isLargerScreen) {
    return Container(
        padding: EdgeInsets.only(top: isLargerScreen ? screenHeight * 0.02 : screenHeight * 0.02, left: screenWidth * 0.08, right: screenWidth * 0.08),
        decoration: BoxDecoration(
            color: Colors.transparent, borderRadius: BorderRadius.circular(25.0), border: Border.all(color: const Color(0x4D000000).withOpacity(0.08), width: 3)),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          TextField(
              ...
              decoration: kTextFieldDecoration.copyWith(
                  errorStyle: const TextStyle(fontSize: 11),
                  isDense: isLargerScreen ? false : true,
                  suffixIconConstraints: BoxConstraints(maxHeight: isLargerScreen ? 40 : 30, maxWidth: 50),
                  errorText: _validateCurrentPassword ? _currentPasswordErrorText : null,
                  hintText: '**********',
                  suffixIcon: IconButton(
                      icon: Icon(_currentPasswordVisible ? Icons.visibility_outlined : Icons.visibility_off_outlined, color: kLightGrey),
                      onPressed: () {
                        setState(() {
          ...
          TextField(
              ...
              decoration: kTextFieldDecoration.copyWith(
                  ...
                  suffixIcon: IconButton(
                      icon: Icon(_newPasswordVisible ? Icons.visibility_outlined : Icons.visibility_off_outlined, color: const Color(0xFF95969D)),
                      onPressed: () {
                        setState(() {
          ...
          TextField(
              ...
              decoration: kTextFieldDecoration.copyWith(
                  ...
                  suffixIcon: IconButton(
                      icon: Icon(_confirmNewPasswordVisible ? Icons.visibility_outlined : Icons.visibility_off_outlined, color: kLightGrey),
                      onPressed: () {
                        setState(() {
          ...
          ElevatedButton(
              ...
              child: _isLoading
                  ? RotatingImage(height: isLargerScreen ? 30 : 22, width: isLargerScreen ? 30 : 22)
                  : Align(alignment: Alignment.center, child: Text('Change password', style: isLargerScreen ? kButtonTextStyle : kButtonTextStyleSmallScreen))),
          SizedBox(height: isLargerScreen ? screenHeight * 0.325 : screenHeight * 0.25)
        ]));
  }

  Future<void> _showChangeProfilePictureDialog(BuildContext context, double screenHeight, double screenWidth, bool isLargerScreen) async {
                  ...
                  content: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                    Center(
                        child: Container(
                            ...
                            decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(6.0)), color: const Color(0xFF4E4949).withOpacity(0.1)),
                            child: ToggleButtons(
                                renderBorder: false,
                                ...
                                constraints: BoxConstraints(
                                    minHeight: screenHeight * 0.04, minWidth: screenWidth * 0.385, maxHeight: screenHeight * 0.06, maxWidth: screenWidth * 0.41),
                                children: [
                                  Container(
                                      padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.11, vertical: 10),
                                      decoration:
                                          BoxDecoration(color: isFirstIndex ? const Color(0xFFFFFFFF) : Colors.transparent, borderRadius: BorderRadius.circular(6)),
                                      child: Text("Picture",
                                          style:
                                              kFont8Black.copyWith(fontSize: 17, fontWeight: FontWeight.w500, color: isFirstIndex ? kHighlightedColor : Colors.black))),
                                  Container(
                                      padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.12, vertical: 10),
                                      decoration:
                                          BoxDecoration(color: isSecondIndex ? const Color(0xFFFFFFFF) : Colors.transparent, borderRadius: BorderRadius.circular(6)),
                                      child: Text("Avatar",
                                          style:
                                              kFont8Black.copyWith(fontSize: 17, fontWeight: FontWeight.w500, color: !isFirstIndex ? kHighlightedColor : Colors.black)))
                                ]))),
                    if (isPictureSelected[1])
                      Column(children: [
                        ...
                        Center(
                          ...
                          Positioned.fill(
                              child: Transform.rotate(
                                  angle: 3.14 / 2, child: const CircularProgressIndicator(backgroundColor: Colors.white, value: 0.5, color: kPurple, strokeWidth: 7)))
                        ])),
                        SizedBox(height: screenHeight * 0.01),
                        Row(children: [Text('Select avatar', style: kFont8Black.copyWith(fontSize: 14))]),
                        const Divider(),
                        SizedBox(height: screenHeight * 0.01),
                        SizedBox(
                            ...
                            child: GridView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return GestureDetector(
                                      ...
                                      child: Container(
                                          decoration: BoxDecoration(
                                              shape: BoxShape.circle, image: DecorationImage(image: AssetImage(avatarList[index + 1]), fit: BoxFit.cover))));
                                }))
                      ]),
                    if (isPictureSelected[0])
                      Column(children: [
                        SizedBox(height: screenHeight * 0.015),
                        Text('Upload picture', style: kFont8Black.copyWith(fontSize: 18, fontWeight: FontWeight.w500)),
                        SizedBox(height: screenHeight * 0.015),
                        DottedBorder(
                            color: kPurple,
                            ...
                            child: ClipRRect(
                                ...
                                child: Container(
                                    ...
                                    decoration: BoxDecoration(shape: BoxShape.rectangle, color: Colors.transparent, borderRadius: BorderRadius.circular(8)),
                                    padding: EdgeInsets.symmetric(vertical: screenHeight * 0.02),
                                    child: Column(children: [
                                      Image.asset(AppImages.uploadFile, height: 35, width: 42),
                                      SizedBox(height: screenHeight * 0.008),
                                      Text('Upload your files here', style: kFont12.copyWith(color: Colors.black)),
                                      SizedBox(height: screenHeight * 0.005),
                                      GestureDetector(
                                          onTap: () async {
                                            ...
                                            if (pickedFile != null) {
                                              ...
                                              customLog("Image picking canceled");
                                            }
                                          },
                                          child: Text('Browse',
                        ...
                        Align(
                            ...
                            child: _fileUploaded
                                ...
                                : const Text('JPG or PNG', style: kFont8Black)),
                        Visibility(
                            visible: _fileUploaded,
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Text(_fileName, style: kFont10.copyWith(color: Colors.black)),
                              Text(_fileSize, style: kFont8.copyWith(color: Colors.black)),
                              const SizedBox(height: 2),
                              LinearProgressIndicator(
                                  minHeight: 1.5, value: _progress, backgroundColor: kPurple, valueColor: const AlwaysStoppedAnimation<Color>(kHighlightedColor)),
                              const SizedBox(height: 2.0),
                              Text('Time remaining: $_timeRemaining', style: kFont7.copyWith(color: const Color(0xFF4E4949))),
                    ...
                    Align(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                          ElevatedButton(
                              ...
                              child: Align(alignment: Alignment.center, child: Text('Cancel', style: kFont12.copyWith(color: Colors.black)))),
                          const SizedBox(width: 4),
                          ElevatedButton(
                              onPressed: () {
                                _fileUploaded = false;
                                if (tempImage != null) {
                                  customLog("Avatar Deleted");
                                } else {
                                  customLog(" Image Deleted");
                                }
                                setState(() {
                                  _isEditProfile = true;
                                  _isMyProfile = false;
