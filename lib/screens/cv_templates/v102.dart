import 'dart:io';
import 'package:crewdog_cv_lab/custom_widgets/custom_widgets.dart';
import 'package:crewdog_cv_lab/custom_widgets/pdf_custom_widgets.dart';
...
class _V102State extends State<V102> {
  ...
  pw.Widget buildTemplate3Pdf(TempController controller, pw.ImageProvider netImage) {
    return pw.Column(
      children: [
