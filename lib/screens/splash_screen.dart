    ...
    return Scaffold(
        body: Container(
            ...
            child: Center(
              ...
              const SizedBox(),
              const SizedBox(),
              Image.asset(AppImages.cvLabLogo, width: isLargerScreen ? screenWidth * 0.65 : screenWidth * 0.55),
              Image.asset(AppImages.dogIcon, height: isLargerScreen ? screenHeight * 0.18 : screenHeight * 0.15)
            ]))));
  }
}
