                          ...
                          children: [
                            Padding(
                              padding: EdgeInsets.fromLTRB(
                                  screenWidth * 0.04, screenHeight * 0.008, screenWidth * 0.04, 0),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Center(
                                  ...
                                  TextField(
                                    ...
                                    onChanged: (value) {
                                      setState(() {
                                        ...
                                        _confirmPasswordErrorText = ''; // Reset error text when the value changes
                                      });
                                    },
                                    style: kTextFieldTextStyle,
                                    decoration: kTextFieldDecoration.copyWith(
                                  ...
                                  ElevatedButton(
                                    onPressed: () async {
                                      ...
                                      setState(() {
                                        ...
                                        _validatePassword = false;
                                        _validateConfirmPassword = false;
                                        _usernameErrorText = 'Name can\'t be empty';
                                        _emailErrorText = 'Email can\'t be empty';
                                        _passwordErrorText = 'Password can\'t be empty';
                                      });
                                      ...
                                      if (_usernameController.text.isEmpty) {
                                        ...
                                        setState(() {
                                          _validateUsername = true;
                                          _usernameErrorText = 'Name must be at least 3 characters';
                                        });
                                      } else if (!isNameValid(_usernameController.text)) {
                                        setState(() {
                                          _validateUsername = true;
                                          _usernameErrorText = 'Name must be only characters';
                                        });
                                      ...
                                      } else if (!passwordContainsAlphabeticAndSpecial.hasMatch(_passwordTextController.text)) {
                                        setState(() {
                                          _validatePassword = true;
                                       ...
                                       try{
                                         ...
                                         if (_registrationSuccessful) {
                                           ...
                                           appSuccessSnackBar("Success",'Signup Successfully. Please login now.',);
                                         }
                                       } finally {
                                         setState(() {
                                           _isLoading = false;
                                    ...
                                    style: ElevatedButton.styleFrom(
                                      ...
                                      padding: EdgeInsets.symmetric(
                                          vertical: screenHeight*0.007, horizontal:screenWidth*0.008
                                      ),
